...
# from src.modules.prediksi.forebet import forebet
from src.modules.prediksi.statarea import statarea
...
def jalankan_prediksi_utama():
    ...
    if konfirmasi_prediksi.lower() == 'y':
        ...
        from src.modules.prediksi.modelPrediksi import make_predictions
        make_predictions()
