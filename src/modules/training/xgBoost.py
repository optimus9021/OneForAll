...
from src.utility.config import test_size
from src.utility.config import max_depth, learning_rate, n_estimators
from src.utility.drop_value import modelTrainingDrop
import pickle
...
def make_model(cv):
    try:
            ...
            nama_file = 'src/utility/accuracy.py'
